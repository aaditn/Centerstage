...
public class FarBlue extends LinearOpMode {
   ...
   // Pose2d startPos = new Pose2d(20,56,Math.toRadians(270));
    ...
    public void runOpMode() throws InterruptedException {
        ...
        TrajectorySequence blueFarRightPlacePurple = m.trajectorySequenceBuilder(blueFarStart)
                .splineTo(new Vector2d(-32, 33), Math.toRadians(-90))
                .splineTo(new Vector2d(-36, 23), Math.toRadians(140))
                .addTemporalMarker(2, () -> {intake.setState(Intake.powerState.LOW); intake.updateLoop(); intake.writeLoop();})
                .build();
        TrajectorySequence blueFarRightFirstCycle = m.trajectorySequenceBuilder(blueFarRightPlacePurple.end())
                ...
                .splineToSplineHeading(new Pose2d(-59, 14,Math.toRadians(180)), Math.toRadians(180))
                .build();
        TrajectorySequence blueFarRightPlaceYellow = m.trajectorySequenceBuilder(blueFarRightFirstCycle.end())
                ...
                .build();
        TrajectorySequence blueFarRightPickAllianceYellow = m.trajectorySequenceBuilder(blueFarRightPlaceYellow.end())
                ...
                .build();
        TrajectorySequence blueFarRightPlaceAllianceYellow = m.trajectorySequenceBuilder(blueFarRightPickAllianceYellow.end())
                .addTemporalMarker(0.3, () -> {intake.setState(Intake.powerState.OFF); intake.updateLoop(); intake.writeLoop();})
        ...
        m.followTrajectorySequence(blueFarRightPlacePurple);
        ...
        m.followTrajectorySequence(blueFarRightFirstCycle);
        ...
        m.followTrajectorySequence(blueFarRightPlaceYellow);
        ...
        m.followTrajectorySequence(blueFarRightPickAllianceYellow);

        m.followTrajectorySequence(blueFarRightPlaceAllianceYellow);
