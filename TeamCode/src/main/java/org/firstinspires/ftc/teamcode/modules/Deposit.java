...
public class Deposit extends Module
{
    ...
    public static double WRIST_TRANSFER=0.78, WRIST_DEPOSIT=0.21, WRIST_HOVER=0.46, WRIST_SCOPE=0.78, WRIST_PARTIAL=0.74;
    ...
    public static double CLAW_OPEN=.70, CLAW_CLOSED_1=0.33, CLAW_CLOSED_2=0.16+.2, CLOSED_AUTO=CLAW_CLOSED_2;
    ...
    public static double ROTATE_MINUS_45=0.32, ROTATE_MINUS_90=0.15, /*UNUSED*/ROTATE_MINUS_135=0.3511, ROTATE_MINUS_180=0.3233, ROTATE_MINUS_225 =0.2955, ROTATE_MINUS_270=0.2677;
