...
public class Deposit extends Module
{
    ...
    public static double WRIST_TRANSFER=.71, WRIST_DEPOSIT=0.05, WRIST_HOVER=0.25+.12, WRIST_SCOPE=WRIST_TRANSFER, WRIST_PARTIAL=0.45+.12, WRIST_DEPOSIT_DOWN=WRIST_DEPOSIT, WRIST_DEPOSIT_SIDE=WRIST_DEPOSIT, WRIST_YELLOW_HOVER=0.29+.12, FLICK = 0.15;
