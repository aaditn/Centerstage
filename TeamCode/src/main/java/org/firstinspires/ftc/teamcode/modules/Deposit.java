...
public class Deposit extends Module
{
    ...
    public static double WRIST_TRANSFER=0.94, WRIST_DEPOSIT=0.2, WRIST_HOVER=0.6, WRIST_SCOPE=0.94, WRIST_PARTIAL=0.84, WRIST_PARTIAL2=0.88;
    ...
    public static double CLAW_OPEN=.70, CLAW_CLOSED_1=0.33, CLAW_CLOSED_2=0.16+.2, CLOSED_AUTO=CLAW_CLOSED_2, CLAW_PRIMED=0.70, CLAW_HALF = .68+.3,CLOSED_EDGE = .11+.3;
