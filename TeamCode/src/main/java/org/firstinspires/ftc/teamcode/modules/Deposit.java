...
public class Deposit extends Module
{
    ...
    public static double FLIP_TRANSFER =0.455, FLIP_DEPOSIT=0.59,FLIP_PRIMED_OLD = FLIP_TRANSFER,FLIP_LEFT = FLIP_DEPOSIT,FLIP_RIGHT = FLIP_DEPOSIT,FLIP_DOWN=0.575, FLIP_PARTIAL=0.48, FlIP_RESET = 0.46;
    ...
    {
        TRANSFER, DEPOSIT, HOVER, TELESCOPE, PARTIAL, DOWN, DEPOSIT_SIDE, YELLOW_HOVER, FLICK;
    }
    public static double WRIST_TRANSFER=.73, WRIST_DEPOSIT=0.25, WRIST_HOVER=0.25+.12, WRIST_SCOPE=WRIST_TRANSFER, WRIST_PARTIAL=0.45+.12, WRIST_DEPOSIT_DOWN=WRIST_DEPOSIT, WRIST_DEPOSIT_SIDE=WRIST_DEPOSIT, WRIST_YELLOW_HOVER=0.29+.12, FLICK = WRIST_HOVER - 0.04;
    public static double[] wristValues={WRIST_TRANSFER, WRIST_DEPOSIT, WRIST_HOVER, WRIST_SCOPE, WRIST_PARTIAL, WRIST_DEPOSIT_DOWN, WRIST_DEPOSIT_SIDE, WRIST_YELLOW_HOVER, FLICK};
    ...
    public static double CLAW_OPEN=.73, CLAW_CLOSED_1=0.27, CLAW_CLOSED_2=0.36, CLAW_AGAIN = 0.27;
    ...
    public static double ROTATE_0=0.4345, ROTATE_PLUS_45=0.455, ROTATE_PLUS_90=0.4875, ROTATE_PLUS_135=0.5210, ROTATE_PLUS_180=0.5475, ROTATE_PLUS_225=0.5775, ROTATE_PLUS_270=0.6075;
    public static double ROTATE_MINUS_45=0.415, ROTATE_MINUS_90=0.378, ROTATE_MINUS_135=0.3511, ROTATE_MINUS_180=0.3233, ROTATE_MINUS_225=0.2955, ROTATE_MINUS_270=0.2677;
