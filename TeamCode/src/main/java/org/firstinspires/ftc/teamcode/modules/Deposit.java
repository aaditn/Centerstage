...
public class Deposit extends Module
{
    ...
    public static double FLIP_TRANSFER =0.455, FLIP_DEPOSIT=0.59,FLIP_PRIMED_OLD = FLIP_TRANSFER,FLIP_LEFT = FLIP_DEPOSIT,FLIP_RIGHT = FLIP_DEPOSIT,FLIP_DOWN=0.6, FLIP_PARTIAL=0.48, FlIP_RESET = 0.46;
