...
public class Deposit extends Module
{
    ...
    {
        TRANSFER, DEPOSIT, PRIMED_OLD, LEFT,RIGHT, DOWN, PARTIAL, RESET, PRELOAD;
    }
    public static double ROTATE_MOD = 0.05;
    public static double FLIP_TRANSFER =0.455, FLIP_DEPOSIT=0.59,FLIP_PRIMED_OLD = FLIP_TRANSFER,FLIP_LEFT = FLIP_DEPOSIT,FLIP_RIGHT = FLIP_DEPOSIT,FLIP_DOWN=0.6, FLIP_PARTIAL=0.48, FlIP_RESET = 0.46, PRELOAD = 0.49;
    public static double[] flipValues={FLIP_TRANSFER, FLIP_DEPOSIT,FLIP_PRIMED_OLD,FLIP_LEFT,FLIP_RIGHT,FLIP_DOWN, FLIP_PARTIAL, FlIP_RESET, PRELOAD};


    public enum WristState implements ModuleState
    {
        TRANSFER, DEPOSIT, HOVER, TELESCOPE, PARTIAL, DOWN, DEPOSIT_SIDE, YELLOW_HOVER, FLICK, ADJUST, PRELOAD
    }
    public static double WRIST_TRANSFER=.73, WRIST_DEPOSIT=0.25, WRIST_HOVER=0.25+.23, WRIST_SCOPE=WRIST_TRANSFER, WRIST_PARTIAL=0.45+.12, WRIST_DEPOSIT_DOWN=WRIST_DEPOSIT, WRIST_DEPOSIT_SIDE=WRIST_DEPOSIT, WRIST_YELLOW_HOVER=0.29+.12, FLICK = WRIST_HOVER - 0.04, ADJUST = WRIST_TRANSFER, PRELOAD_VAL = WRIST_PARTIAL - 0.02;
    public static double[] wristValues={WRIST_TRANSFER, WRIST_DEPOSIT, WRIST_HOVER, WRIST_SCOPE, WRIST_PARTIAL, WRIST_DEPOSIT_DOWN, WRIST_DEPOSIT_SIDE, WRIST_YELLOW_HOVER, FLICK, ADJUST, PRELOAD_VAL};
    ...
    public static double CLAW_OPEN=.62, CLAW_CLOSED_1=0.25, CLAW_CLOSED_2=0.32, CLAW_AGAIN = 0.27;
