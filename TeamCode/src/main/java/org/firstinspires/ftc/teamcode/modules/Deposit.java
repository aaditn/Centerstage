...
public class Deposit extends Module
{
    ...
    public static double WRIST_TRANSFER=0.55, WRIST_DEPOSIT=0.03, WRIST_HOVER=0.25, WRIST_SCOPE=WRIST_TRANSFER, WRIST_PARTIAL=0.45, WRIST_DEPOSIT_DOWN=WRIST_DEPOSIT, WRIST_DEPOSIT_SIDE=WRIST_DEPOSIT, WRIST_YELLOW_HOVER=0.29;
