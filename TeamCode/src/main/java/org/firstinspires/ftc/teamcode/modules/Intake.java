...
public class Intake extends Module {
    ...
    public static double POSITION_RAISED=0.05,  POSITION_MID=0.21, POSITION_DOWN=0.315, AUTO=POSITION_DOWN;
    ...
    public static double SWEEPER_ZERO=0.1, SWEEPER_INIT=0.1625, SWEEPER_ONE=0.215, SWEEPER_TWO=0.33, SWEEPER_THREE=0.445, SWEEPER_FOUR=0.56,SWEEPER_FIVE=.655,SWEEPER_SIX=.755,SWEEPER_SEVEN = .84,SWEEPER_EIGHT=.955;
