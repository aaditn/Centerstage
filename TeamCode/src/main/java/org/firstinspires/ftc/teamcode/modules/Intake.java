...
public class Intake extends Module {
    ...
    {
        ZERO, INIT, ONE_SWEEP, TWO_SWEEP, THREE_SWEEP,FOUR_SWEEP,FIVE_SWEEP;
    }
    public static double SWEEPER_ZERO=0.035, SWEEPER_INIT=0.09, SWEEPER_ONE=0.15, SWEEPER_TWO=0.265, SWEEPER_THREE=0.38, SWEEPER_FOUR=0.495,SWEEPER_FIVE=.59;
    public static double[] sweeperValues={SWEEPER_ZERO, SWEEPER_INIT, SWEEPER_ONE, SWEEPER_TWO, SWEEPER_THREE, SWEEPER_FOUR,SWEEPER_FIVE};
