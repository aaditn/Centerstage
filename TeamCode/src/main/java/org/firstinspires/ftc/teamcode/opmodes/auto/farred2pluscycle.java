...
boolean offset;
    ...
    public void linearOpMode() {
        ...
        TrajectorySequence stackToBack = drive.trajectorySequenceBuilder(leftBackToStack.end())
                .setReversed(true)
                ...
                .build();
        TrajectorySequence backToStack = drive.trajectorySequenceBuilder(stackToBack.end())
