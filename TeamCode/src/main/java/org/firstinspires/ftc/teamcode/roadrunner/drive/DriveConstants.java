...
public class DriveConstants {
     ...
     * convengience. Make sure to exclude any gear ratio included in MOTOR_CONFIG from GEAR_RATIO.
     */
    public static double WHEEL_RADIUS = 1.88976; // in
    public static double GEAR_RATIO = 28.0/24.0; // output (wheel) speed / input (motor) speed
